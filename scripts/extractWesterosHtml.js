...
const SOURCE_FILE = path.join(process.cwd(), "thegameofthronesmap_westeros.html");
...
function extractWesterosFragments() {
  ...
  // For westeros page, we need to preserve the full structure but extract the main content
  ...
  ensureDataDir();
  writeFragment("westeros-head.html", cleanedHead);
  writeFragment("westeros-body.html", cleanedMainContent);

  console.log("Westeros page fragments extracted successfully!");
}

extractWesterosFragments();