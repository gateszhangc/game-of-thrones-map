...
const SOURCE_FILE = path.join(process.cwd(), "thegameofthronesmap_essos.html");
...
function extractEssosFragments() {
  ...
  // For essos page, we need to preserve the full structure but extract the main content
  ...
  ensureDataDir();
  writeFragment("essos-head.html", cleanedHead);
  writeFragment("essos-body.html", cleanedMainContent);

  console.log("Essos page fragments extracted successfully!");
}

extractEssosFragments();