...
const SOURCE_FILE = path.join(process.cwd(), "thegameofthronesmap_houses.html");
...
function extractHousesFragments() {
  ...
  // For houses page, we need to preserve the full structure but extract the main content
  ...
  ensureDataDir();
  writeFragment("houses-head.html", cleanedHead);
  writeFragment("houses-body.html", cleanedMainContent);

  console.log("Houses page fragments extracted successfully!");
}

extractHousesFragments();